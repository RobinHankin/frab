...
location, as per \CRANpkg{disordR} discipline.
...
If these cyclic goups are generated by $\left\lbrace x_i\colon
...
\begin{centering}
\includegraphics[width=0.25\linewidth]{commuting_diagram.pdf}
\end{centering}
